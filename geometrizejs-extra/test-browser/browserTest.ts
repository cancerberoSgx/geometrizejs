...
test('browser tests', async t => {
  ...
  t.notThrows(() => execSync('rm -rf test-browser-outdir; mkdir -p test-browser-outdir; cp test/assets/* test-browser-outdir ', { stdio: 'inherit' }), 'mkdir -p test-browser-outdir')
